{ lib, stdenv, buildGoModule, fetchFromGitHub, git, python3, postgresql_16, nodejs, pnpm, libobjc, IOKit, toybox, coreutils, jq }:
...
buildGoModule rec {
  ...
  nativeBuildInputs = [
    ...
    (buildGoModule rec {
      ...
      vendorHash = "sha256-afPQZigwqc+gxJRz9VTG491fQEdw/iD9edoEdKBl1ms=";
      doCheck = false;
      outputs = [ "out" ];
      buildPhase = ''
