[
  {
    goPackagePath = "github.com/garslo/gogen";
    fetch = {
      type = "git";
  ...
  {
    goPackagePath = "github.com/kylelemons/godebug/diff";
    fetch = {
      type = "git";
  ...
  {
    goPackagePath = "golang.org/x/tools/go/ast/astutil";
    fetch = {
      type = "git";
  ...
  {
    goPackagePath = "golang.org/x/tools/go/buildutil";
    fetch = {
      type = "git";
      url = "https://go.googlesource.com/tools";
      rev = "6e7ee5a9ec598d425ca86d6aab6e76e21baf328c";
  ...
  {
    goPackagePath = "golang.org/x/tools/go/loader";
    fetch = {
      type = "git";
      url = "https://go.googlesource.com/tools";
      rev = "6e7ee5a9ec598d425ca86d6aab6e76e21baf328c";
  ...
  {
    goPackagePath = "golang.org/x/tools/imports";
    fetch = {
      type = "git";
      url = "https://go.googlesource.com/tools";
      rev = "6e7ee5a9ec598d425ca86d6aab6e76e21baf328c";
